...
class ProjectController
{
    ...
    public function index(): void
    {
        ...
        $in_progress_projects = $this->project->getInProgressProjects(Auth::id(), 'user');

        view('projects.index', compact('passed_projects', 'upcoming_projects', 'in_progress_projects'));
    }
        ...
        if ($this->project->create($filtered_data)) {
            ...
            if (isset($_REQUEST['contacts'])) {
                foreach ($_REQUEST['contacts'] as $contact_id) {
                    ...
                    $this->project_contact->create(compact('project_id', 'contact_id', 'role'));
                }
            }
    ...
    public function show(): void
    {
        ...
        $project = $this->project->fetchProject($project->id);

        $contacts = $this->project->fetchContacts($project->id, 'project');
    ...
    #[NoReturn] public function update(): void
    {
        ...
        $this->project->update($id, $project_data);
