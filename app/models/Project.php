...
class Project extends Database
{
    ...
    public function getPassedProjects(int|string $id, string $model_name): array|false
    {
    ...
    public function getInProgressProjects(int|string $id, string $model_name): array|false
    {
        $foreign_key = "{$model_name}_id";
        $sql = <<<SQL
        SELECT * from $this->table
    ...
    public function fetchContacts(int|string $id, string $model_name): false|array
    {
        $foreign_key = "{$model_name}_id";
        $sql = <<<SQL
        SELECT c.name, projects_contacts.role from projects_contacts
        JOIN jiri.contacts c on projects_contacts.contact_id = c.id
        WHERE $foreign_key = :id;
        SQL;
